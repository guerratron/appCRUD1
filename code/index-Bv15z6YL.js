...
`,Y,C=class extends A{constructor(){super(),ve(this,Y,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([r,t])=>{this.constructor.define(r,t)})}emit(r,t){const e=new CustomEvent(r,F({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(e),e}static define(r,t=this,e={}){const o=customElements.get(r);if(!o){try{customElements.define(r,t,e)}catch{customElements.define(r,class extends t{},e)}return}let s=" (unknown version)",i=s;"version"in t&&t.version&&(s=" v"+t.version),"version"in o&&o.version&&(i=" v"+o.version),!(s&&i&&s===i)&&console.warn(`Attempted to register <${r}>${s}, but <${r}>${i} has already been registered.`)}attributeChangedCallback(r,t,e){me(this,Y)||(this.constructor.elementProperties.forEach((o,s)=>{o.reflect&&this[s]!=null&&this.initialReflectedProperties.set(s,this[s])}),ye(this,Y,!0)),super.attributeChangedCallback(r,t,e)}willUpdate(r){super.willUpdate(r),this.initialReflectedProperties.forEach((t,e)=>{r.has(e)&&this[e]==null&&(this[e]=t)})}};Y=new WeakMap;C.version="2.18.0";C.dependencies={};h([u()],C.prototype,"dir",2);h([u()],C.prototype,"lang",2);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var $r=Object.defineProperty,xr=Object.getOwnPropertyDescriptor,de=(r,t,e,o)=>{for(var s=o>1?void 0:o?xr(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&$r(t,e,s),s};let tt=class extends A{constructor(){super(...arguments),this.message="Welcome!"}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return v`
  ...
  `];de([u()],tt.prototype,"message",2);tt=de([yt("app-home")],tt);var Ar=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Et=(r,t,e,o)=>{for(var s=o>1?void 0:o?Cr(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&Ar(t,e,s),s};let j=class extends A{constructor(){super(...arguments),this.title="appCRUD1",this.enableBack=!1}render(){return v`
      <header>
...
//# sourceMappingURL=index-Bv15z6YL.js.map
